            ...
            <DropdownMenuContent className="w-56 p-2" sideOffset={10}>
                <div className='w-full p-4 flex gap-2 items-center'>
                    ...
                    <div className='flex flex-col'>
                        <span className='text-sm font-medium truncate text-foreground'>{userFullname}</span>
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem asChild>
                    <OnboardingModal featureList={onboardingFeatures} className='cursor-pointer flex select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none transition-colors focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50'>
                        <div data-testid="" >
